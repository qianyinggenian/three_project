...
export default {
  ...
  methods: {
    ...
    initGUI () {
      ...
      light1Folder.add(directionalLight1.position, 'x', -50000, 50000).name('Position X').step(0.01).onChange(this.render);
      light1Folder.add(directionalLight1.position, 'y', -50000, 50000).name('Position Y').step(0.01).onChange(this.render);
      light1Folder.add(directionalLight1.position, 'z', -50000, 50000).name('Position Z').step(0.01).onChange(this.render);
      ...
      light2Folder.add(directionalLight2.position, 'x', -50000, 50000).name('Position X').step(0.01).onChange(this.render);
      light2Folder.add(directionalLight2.position, 'y', -50000, 50000).name('Position Y').step(0.01).onChange(this.render);
      light2Folder.add(directionalLight2.position, 'z', -50000, 50000).name('Position Z').step(0.01).onChange(this.render);
